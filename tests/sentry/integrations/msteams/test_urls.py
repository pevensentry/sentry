...
PATHS_TO_ROUTE_NAMES = [
    ("/extensions/msteams/webhook", "sentry-integration-msteams-webhook"),
    ("/extensions/msteams/configure", "sentry-integration-msteams-configure"),
    (
        "/extensions/msteams/link-identity/signedparams123",
        "sentry-integration-msteams-link-identity",
    ),
    (
        "/extensions/msteams/unlink-identity/signedparams123",
