...
# tests sentry.integrations.github.urls
# included in top-level route as "extensions/github/.."

PATHS_TO_ROUTE_NAMES = [
    ("/extensions/github/webhook", "sentry-extensions-github-webhook"),
    ("/extensions/github/search/orgslug/1234", "sentry-extensions-github-search"),
]
