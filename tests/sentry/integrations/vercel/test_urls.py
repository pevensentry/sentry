...
PATHS_TO_ROUTE_NAMES = [
    ("/extensions/vercel/webhook", "sentry-extensions-vercel-webhook"),
    ("/extensions/vercel/configure", "sentry-extensions-vercel-configure"),
    ("/extensions/vercel/delete", "sentry-extensions-vercel-generic-webhook"),
]
