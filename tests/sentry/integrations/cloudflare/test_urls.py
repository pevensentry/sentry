...
# tests sentry.integrations.cloudflare.urls
# included in top-level route as "extensions/cloudflare/.."

PATHS_TO_ROUTE_NAMES = [
    ("/extensions/cloudflare/metadata", "sentry-extensions-cloudflare-metadata"),
    ("/extensions/cloudflare/webhook", "sentry-extensions-cloudflare-webhook"),
]
