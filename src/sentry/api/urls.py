...
GROUP_URLS = [
    ...
    url(
        ...
        name="sentry-api-0-group-activities",
    ),
    url(
        r"^(?P<issue_id>[^\/]+)/events/?$",
    ...
    url(
        ...
        name="sentry-api-0-group-tag-key-detail",
    ),
    url(
    ...
    url(
        ...
        name="sentry-api-0-user-reports",
    ),
    url(
        r"^(?P<issue_id>[^\/]+)/attachments/?$",
        GroupAttachmentsEndpoint.as_view(),
        name="sentry-api-0-group-attachments",
    ),
    url(
    ...
    url(
        ...
        name="sentry-api-0-group-external-issue-detail",
    ),
    url(
    ...
    url(
        ...
        name="sentry-api-0-group-current-release",
    ),
    url(
        r"^(?P<issue_id>[^\/]+)/first-last-release/?$",
        GroupFirstLastReleaseEndpoint.as_view(),
        name="sentry-api-0-group-first-last-release",
    ),
...
urlpatterns = [
    # Relay
    url(
        # TODO(mdtro): fix the optional trailing slash once all routes are adjusted and the 'catch-all' routes
        #  behave correctly. Django will usually redirect to route + "/" if there wasn't a match, but our
        #  catchall routes will typically always match, so the redirect including the trailing slash rarely
        #  happens.
        r"^relays/?",
        include(
            [
    ...
    url(
        ...
        name="sentry-api-0-broadcast-detail",
    ),
    # Project transfer
    url(
        r"^accept-transfer/?$",
